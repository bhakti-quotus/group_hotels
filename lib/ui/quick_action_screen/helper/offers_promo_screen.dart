...
class _OffersHeaderDelegate extends SliverPersistentHeaderDelegate {
  ...
  @override
  bool shouldRebuild(_OffersHeaderDelegate oldDelegate) => true;
...
// ─── OFFER DATA (5 CARDS AS REQUESTED) ─────────────────────────────────────
const List<OfferSection> offerSections = [
  OfferSection(
    title: 'Black Friday Sale',
    badge: 'PROMOTIONS',
    validUntil: '3 years ago',
    description:
        'You can enjoy up to 30% off on your stay, simply book during the period from November 18, 2025 till December 3, 2025 and the discounted rate will automatically be applied.',
  ...
  OfferSection(
    ...
    validUntil: '3 years ago',
    description:
        'Beat the holiday boredom and keep the whole family entertained while enjoying our lowest rates when you book in advance.',
    imagePath: 'assets/images/offer2.png',
  ),
  OfferSection(
    title: 'Minimum Stay Offer',
    badge: 'PROMOTIONS',
    validUntil: '4 years ago',
    description:
        'A vacation escape awaits. Enjoy your next getaway with our minimum stay packages.',
    imagePath: 'assets/images/offer3.png',
  ),
  OfferSection(
    title: 'Stella Member',
    badge: 'PROMOTIONS',
    validUntil: '5 years ago',
    description:
        'Discover thousands of benefits from being a Stella member. You can enjoy up to 20% off on your stay, simply sign up and the discounted rate will automatically be applied.',
    imagePath: 'assets/images/offer4.png',
  ),
  OfferSection(
    title: 'Mobile Discount',
    badge: 'PROMOTIONS',
    validUntil: '5 years ago',
    description:
        'Time for a recharge? Reset your mind and book your stay on our website using your mobile to enjoy a 10% discount.',
    imagePath: 'assets/images/offer5.png',
  ),
];

// ─── OFFER CARD WIDGET (MATCHING REFERENCE UI STYLE) ───────────────────────
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: const LinearGradient(
                            colors: [
                              Color.fromARGB(255, 238, 150, 220),
                              Color.fromARGB(255, 241, 139, 250),
                              Color.fromARGB(255, 198, 74, 210),
                            ],
                          ),
              ...
              const SizedBox(height: 20),
              // Title (serif italic, matching reference)
              Text(
                offer.title,
                style: const TextStyle(
                  fontFamily: 'Georgia',
